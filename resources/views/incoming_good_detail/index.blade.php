                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                        <a class="dropdown-item camera" href="javascript:void(0)"
                                                            data-kamera-href="{{ route('incoming-good-detail.kamera', $item->id) }}" data-kamera-href="'. route('product.kamera', $data->id) .'" data-toggle="modal" data-target="#modalKamera">
                                                    ...
                                                    <a class="dropdown-item delete" href="javascript:void(0)"
                                                        ...
                                                        data-delete-href="{{ route('incoming-good-detail.destroy', $item->id) }}">

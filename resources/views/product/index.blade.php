                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="model_name" class="form-control" placeholder="Model Produk">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="file_photo" class="form-control" placeholder="Foto Produk">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="minimal_stock" placeholder="Minimal Stok"
                                        class="form-control">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label> Stok </label>
                                    <input type="number" name="stock" readonly class="form-control"
            ...
            <div class="modal-content">
                ...
                <form id="formKamera" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <div class="mb-3">
                                    <button id="activateCamera" type="button"
                                        class="btn btn-xs btn-outline-success mt-2">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" data-style="expand-left"><i
                                class="fa fa-check"></i> Simpan Foto</button>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    $(editBtn).on('click', function() {
                        ...
                        $.get({
                            ...
                            .done(response => {
                                ...
                                $formUpdate.find(`[name="id_brand"]`).val(product.id_brand)
                                    .trigger('change');
                                ...
                                $formUpdate.find('[name="minimal_stock"]').val(product
                                    .minimal_stock).trigger('change')

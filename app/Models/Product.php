...
class Product extends Model
{
	...
	public function imageCapture($file)
	{
		if($file) {
            ...
            $imageUrl = $file;
            $filePath = 'product_photo/'.$filename;
                ...
                $action = '
                	<div class="dropdown">
						...
						<div class="dropdown-menu">
							<a class="dropdown-item camera" href="javascript:void(0);" data-kamera-href="'. route('product.kamera', $data->id) .'" data-toggle="modal" data-target="#modalKamera">

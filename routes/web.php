...
Route::group([ 'middleware' => 'auth' ], function(){
	...
	Route::prefix('product')->group(function(){
		...
		Route::put('/{product}/kamera', [ProductController::class, 'Kamera'])->name('product.kamera');
   ...
   Route::prefix('incoming-goods')->group(function(){
    ...
    Route::prefix('incoming-good-detail')->group(function(){
        ...
        Route::put('{incomingGoodDetail}/kamera', [incomingGoodDetailsController::class, 'kamera'])->name('incoming-good-detail.kamera');
        Route::get('{incomingGoods}/detail', [incomingGoodDetailsController::class, 'detail'])->name('incoming-goods.detail');
	...
	Route::prefix('outgoing-good-detail')->group(function(){
		...
		Route::put('/{outgoingGoodDetail}/kamera', [OutgoingGoodsDetailController::class, 'Kamera'])->name('outgoing-good-detail.kamera');
